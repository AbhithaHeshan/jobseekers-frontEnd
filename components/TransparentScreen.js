...
export default function TransparentScreen(props) {
  return (
    <div style={{position:'absolute',width:'120vh',height:'85vh',backgroundColor:'#FFFFFF',top:'0',bottom:'0',left:"0",right:'120px',margin:'auto',border:'2px solid #DFD7FF',borderRadius:'10px',display:props.visible ? 'flex' : 'none'}}>
